        ...
        <div className="container-luxe grid gap-12 md:grid-cols-12 md:gap-20 items-center">
          <Reveal className="md:col-span-5 md:col-start-2">
            <div className="aspect-[4/5] overflow-hidden bg-muted">
              ...
              <img src="https://ui-avatars.com/api/?name=Lalprasath&background=222222&color=D4AF37&size=512&font-size=0.33" alt="Mr. Lalprasath - CEO and Founder" loading="lazy" className="h-full w-full object-cover object-top" />
            </div>
          </Reveal>
